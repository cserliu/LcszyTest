package com.liucs.java.reflect.dynamic;
...
public class MainClass {
	...
	public static void test2(){
		...
		System.out.println("共卖了" + ((ComputerProviderProxy)lenovo).sellCount + "台电脑");
		System.out.println("共买了" + ((ComputerProviderProxy)lenovo).buyCPUCount + "片CPU");
	}
	...
	public static void test3(){
		...
		ComputerProvider lenovo = (ComputerProvider) Proxy.newProxyInstance(
				...
				new Class<?>[]{ComputerProvider.class}, 
				cnt
		);
